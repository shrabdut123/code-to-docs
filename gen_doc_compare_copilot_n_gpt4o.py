...
import json
import os
from translations import code_snippet, copilot_translation, gpt4o_translation
...
def compare_translations(code_snippet, copilot_translation, gpt4o_translation):
    evaluation_prompt = f"""
    ...
    **Translation 1 (GitHub Copilot):**
    "{copilot_translation}"

    **Translation 2 (GPT-4o):**
    "{gpt4o_translation}"
...
# Run Evaluation
evaluation_result = compare_translations(code_snippet, copilot_translation, gpt4o_translation)
